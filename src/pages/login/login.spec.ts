...
describe('Login Username & Password Validation (Login Page)', () => {
  ...
  // }));
  	...
  	// Test Case 1: 
	it("Correct Email Address & Password - Pass", function(done) {
		let user_test = {
	...
	it("Invalid Email Address - Fail", function(done) {
  	...
  	// Test Case 3: 
	it("Wrong Password - Fail", function(done) {
		let user_test = {
  	...
  	// Test Case 4: 
	it("Username not found - Fail", function(done) {
		let user_test = {
		email: "guanlun_zhao@mymail.sutd.edu.sg",
		password: "666"
		};
  	...
  	// Test Case 5: 
	it("User disabled - Fail", function(done) {
		let user_test = {
		email: "guanlun_zhao@mymail.sutd.edu.sg",
		password: "666"
		};
